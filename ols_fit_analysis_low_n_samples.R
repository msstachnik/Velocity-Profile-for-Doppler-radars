...
## Analysis for low number of samples 
two_samples = base::subset(vp_out, n_samples_label == "low");
...
plot_labels_two_samples = list(xlabel = "Reference magnitude [m/s]", 
                               title = "Analysis of Velocity Profile solution accuracy for low n samples",
                               legend = "Reference\nazimuth spread\n[deg]");
...
plot_labels_two_samples_az$title = "Analysis of Velocity Profile solution accuracy for low n samples and low azimuth spread";
ggplot_rms_by_ref_and_group_4_plots(base::subset(two_samples, (az_spread_ref_label == "low")),
                                    "heading_ref", "mag_ref_label", plot_labels_two_samples_az)

plot_labels_two_samples_az$title = "Analysis of Velocity Profile solution accuracy for low nsamples and medium azimuth spread";
ggplot_rms_by_ref_and_group_4_plots(base::subset(two_samples, (az_spread_ref_label == "medium")),
                                    "heading_ref", "mag_ref_label", plot_labels_two_samples_az)

plot_labels_two_samples_az$title = "Analysis of Velocity Profile solution accuracy for low n samples and high azimuth spread";
